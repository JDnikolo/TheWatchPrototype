...
using ListMode = UI.Layout.Elements.LayoutList.Mode;

namespace Editor
{
	[CustomEditor(typeof(LayoutList), true)]
	[CanEditMultipleObjects]
	public class LayoutListEditor : LayoutElementEditor
	{
