...
namespace Interactables.Actions.Animation
{
    ...
    public sealed class InteractableSetAnimationParameter : Interactable
    {
        ...
        public override void Interact()
        {
            ...
            switch (parameterType)
            {
                case AnimatorControllerParameterType.Float:
                    animationController.SetAnimationParameter(parameterHash, parameterValueFloat, duration,
                        onAnimationEnd);
                    break;
                case AnimatorControllerParameterType.Int:
                    animationController.SetAnimationParameter(parameterHash, parameterValueInt, duration,
                        onAnimationEnd);
                    break;
        ...
        class ISAPEditor : Editor
        {
            public override void OnInspectorGUI()
            {
                ...
                var propertiesToExclude = new List<string>
                    {"parameterValueFloat", "parameterValueInt", "parameterValueBool"};
